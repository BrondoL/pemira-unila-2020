...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <center>
        <h1 class="h3 mb-4 text-gray-800">Pemilihan DPM Fakultas</h1>
    </center>
            ...
            <div class="card-body">
                ...
                <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                    <div class="btn-group mr-2" role="group" aria-label="First group">
                        <a href="<?= base_url('user/pilihDpmf/') . $d['id']; ?>" class="btn btn-danger" onclick="return confirm ('apakah anda yakin?');">Pilih</a>
                    </div>
                    <div class="btn-group mr-2" role="group" aria-label="Second group">
                        <a href="<?= base_url('user/detailDpmf/') . $d['id']; ?>" class="btn btn-warning">Details</a>
                    </div>
                </div>
            </div>
        </div>
