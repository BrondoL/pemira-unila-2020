                        ...
                        <tbody>
                            ...
                            <?php foreach ($dpmu as $d) : ?>
                                <tr>
                                    ...
                                    <td style="vertical-align: middle;"><?= $d['fakultas']; ?></td>
            ...
            <div class="modal fade" id="newSubmenuModal" tabindex="-1" aria-labelledby="newSubmenuModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="<?= base_url('Admin/dpmu'); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal fade" id="editMahasiswa<?= $d['id']; ?>" tabindex="-1" aria-labelledby="editMahasiswaLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form action="<?= base_url('Admin/editdpmu/' . $d['id']); ?>" method="POST" enctype="multipart/form-data">
                                <div class="modal-body">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="jurusan" name="jurusan" placeholder="Masukkan Jurusan..." value="<?= $d['jurusan']; ?>">
                                    </div>
                                    <div class="form-group">
                ...
                <div class="modal fade" id="deleteMahasiswa<?= $d['id']; ?>" tabindex="-1" aria-labelledby="deleteMahasiswa<?= $d['id']; ?>" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form action="<?php echo base_url('admin/deletedpmu/') . $d['id']; ?>" method="POST">
